...
class Account extends classes_1.Transformable {
    /**
     * @remarks
    ...
    getCharacters(options) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield Characters.get(this.name, options);
        });
    }
}
__decorate([
    class_transformer_1.Type(/* istanbul ignore next */ () => streams_1.Stream)
], Account.prototype, "twitch", void 0);
__decorate([
    class_transformer_1.Type(/* istanbul ignore next */ () => guild_1.Guild)
], Account.prototype, "guild", void 0);
